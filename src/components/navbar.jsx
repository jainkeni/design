  ...
  return (
    <div className='relative w-screen mt-4'>
      <nav className="border-gray-200 bg-white dark:border-gray-700">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 ml-10">
          <a href="#" className="flex items-center rtl:space-x-reverse">
              <span className="self-center text-4xl font-semibold whitespace-nowrap dark:text-purple-700 ps-28">Image</span>
          </a>
          ...
          <div className="hidden w-full md:block md:w-2/3" id="navbar-solid-bg">
            <ul className="flex flex-col  font-medium mt-4 rounded-lg md:space-x-32 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent md:dark:bg-transparent  ">
              <li className='flex flex-col items-center'>
                <MdOutlineDashboard className="text-gray-700 text-4xl" />
              ...
              <li className='flex flex-col items-center'>
              <GrDocumentUser className="text-gray-700 text-4xl" />
              ...
              <li className='flex flex-col items-center'>
              <GrUserWorker className="text-gray-700 text-4xl" />
              ...
              <li className='flex flex-col items-center'>
              <IoSettingsOutline className="text-gray-700 text-4xl" />
              ...
              <li className='flex flex-col items-center'>
              <LuWarehouse className="text-gray-700 text-4xl" />
